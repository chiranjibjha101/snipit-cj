...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if your Asset Management installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    'site_name'                 => 'Site Name',
    ...
    'version_footer_help'       => 'Specify who can see the Asset Management Version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link to Asset Management in Emails',
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not wish to link back to your Asset Management installation in your email footers. Useful if most of your users never login. ',
    'text_pt'        => 'pt',
